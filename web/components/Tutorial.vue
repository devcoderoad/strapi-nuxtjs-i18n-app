...
<template>
  ...
  >
    ...
    <CPseudoBox>
      <CBox display="flex" alignItems="center" justifyContent="center">
        <a v-chakra href="https://github.com/nuxt/nuxt.js" target="_blank"
          ><svg
          ...
          >
            ...
            /></svg
        ></a>
        <a v-chakra href="https://twitter.com/nuxt_js" target="_blank"
          ><svg
